...
import { editQuestionReact } from '../api/QuizApi.js'
import { editQuestionAngular } from '../api/QuizApi.js'
...
class EditQuestion extends React.Component {
    ...
    submitForm(event) {
        ...
        if (this.state.which === "React") {
            editQuestionReact(this.state.Id, editedQuestion); //to do bazy
        }
        else if (this.state.which === "Angular") {
            editQuestionAngular(this.state.Id, editedQuestion); //to do bazy
        }
